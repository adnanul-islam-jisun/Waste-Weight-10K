...
The **Waste-Weight-10K** dataset (images and metadata) is available by request only — see [Dataset Access](../README.md#-dataset-access) in the main README for instructions.
